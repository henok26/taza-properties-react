  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ y: 50, opacity: 0 }}
        className="bg-gray-900 text-white w-full max-w-4xl h-full md:h-[90vh] rounded-2xl overflow-y-auto"
        onClick={e => e.stopPropagation()}
      >
        <div className="relative">
          <img src={property.image} alt={property.title} className="w-full h-64 md:h-96 object-cover"/>
        ...
        <div className="p-6 md:p-8">
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-6">{property.details}</p>
          <p className="text-2xl md:text-3xl font-bold text-[#42C2B3] mb-8">{property.price}</p>
